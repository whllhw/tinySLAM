...
function(a) {
    ...
    a.getTranslate = function(a, b) {
        ...
        window.WebKitCSSMatrix ? f = new WebKitCSSMatrix("none" === e.webkitTransform ? "" : e.webkitTransform) : (f = e.MozTransform || e.transform || e.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"),
        c = f.toString().split(",")),
...
+function(a) {
    ...
    var b = function(b) {
        ...
        g.open = function() {
            ...
            a(g.params.container).append(g.container),
            g.opened = !0) : (g.container = a(a.pickerModal(g.pickerHTML)),
            a(g.container).one("opened", function() {
                g.opened = !0
            }).on("close", function() {
                f()
            })),
...
+function(a) {
    ...
    var d = function(b, c) {
        ...
        if (f) {
            ...
            m && (this.$pageContent[0].scrollTop = 0,
            this.scrollTop(m))
        } else
...
+function(a) {
    ...
    var c = function(b, c) {
        ...
        this.options = a.extend({}, this._defaults, {
            fixedTop: f,
            shadow: e,
            offset: 0
        }, c),
    ...
    c.prototype = {
        ...
        _scrollHandler: function(b) {
            var c = a(b.target)
              ...
              , i = h >= g - f;
            i ? (e.insertAfter(d),
            d.addClass("buttons-fixed").css("top", f)) : (e.remove(),
            d.removeClass("buttons-fixed").css("top", 0))
        }
    },
    a.fn.fixedTab = b,
    a.fn.fixedTab.Constructor = c,
    a(document).on("pageInit", function() {
        a.initFixedTab()
    })
}(Zepto),
+function(a) {
...
+function(a) {
    ...
    i.prototype._init = function() {
        ...
        if (i.fragment && (g = b.find("#" + i.fragment)),
        g && g.length ? k = g.eq(0) : k.length || (k = j.eq(0)),
        k.attr("id") || k.attr("id", this._generateRandomId()),
        l.length && l.attr("id") !== k.attr("id") ? (l.removeClass(f.curPageClass),
        k.addClass(f.curPageClass)) : k.addClass(f.curPageClass),
        d = k.attr("id"),
        null === h.state) {
            var m = {
    ...
    i.prototype.load = function(b, c) {
        void 0 === c && (c = !1),
        this._isTheSameDocument(location.href, b) ? this._switchToSection(e.getUrlFragment(b)) : (this._saveDocumentIntoCache(a(document), location.href),
        this._switchToDocument(b, c))
    }
    ,
    ...
    i.prototype._switchToSection = function(b) {
        if (b) {
            var c = this._getCurrentSection()
              , d = a("#" + b);
            c !== d && (this._animateSection(c, d, g.rightToLeft),
            this._pushNewState("#" + b, b))
        }
    }
    ,
    ...
    i.prototype._loadDocument = function(b, c) {
        ...
        ,
        this.xhr.abort(),
        this.dispatch(d.pageLoadCancel)),
    ...
    i.prototype._back = function(b, c) {
        if (this._isTheSameDocument(b.url.full, c.url.full)) {
            ...
            this._saveDocumentIntoCache(a(document), c.url.full),
